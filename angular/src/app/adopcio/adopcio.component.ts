...
@Component({
  selector: 'app-adopcio',
  templateUrl: './adopcio.component.html',
  styleUrls: ['./adopcio.component.css']
})
export class AdopcioComponent implements OnInit {

  navbar: any;
  link: any;
  previous: any;
  next: any;
  adopcio:string = 'Adopcio';
  offset: number = 0;
  gossos: any;
  id:any;
  count: any;
